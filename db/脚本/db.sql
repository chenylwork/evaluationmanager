...
insert  into `evaluation_info`(`id`,`paper`,`user`,`teacher`,`time`,`options`,`score`) values (1,'1226955136','songyixue','renqizhong','2018-08-26 02:31:07','AAAAAAAAAA',98);
...
insert  into `paper`(`id`,`paperNo`,`type`,`description`,`startTime`,`endTime`) values (18,'1226955136','P1','ddffdd','2018-08-08','2018-07-30'),(19,'1226970113','P1','dfdfddf','2018-08-13','2018-08-06'),(20,'674401836','P1','一组试卷','2018-08-07','2018-08-31'),(21,'1765835809','P1','作者嘻嘻嘻','2018-08-01','2018-08-02');
...
insert  into `powertype`(`id`,`name`,`powerTypeNo`,`codeNo`) values (1,'院系管理','01','H'),(2,'专业管理','02','H'),(3,'班级管理','03','H'),(4,'教师管理','04','H'),(5,'学生管理','05','H'),(6,'用户管理','06','H'),(7,'测评管理','07','H'),(8,'试题管理','08','H'),(9,'试卷管理','09','H'),(10,'角色管理','10','H'),(11,'权限管理','11','H'),(12,'日志管理','12','H'),(13,'数据管理','13','H'),(14,'公用界面','14','H'),(15,'信息查询','15','Q'),(16,'个人信息','16','Q'),(18,'网上评教','18','Q'),(19,'学期测评','19','Q');
...
insert  into `role`(`id`,`no`,`name`,`type`,`description`) values (1,'0001','高级管理员','R00',NULL),(2,'0002','中级管理员','R00',NULL),(3,'0003','初级管理员','R00',NULL),(4,'0100','院长','R01',NULL),(5,'0101','教学督导','R01',NULL),(6,'0102','院领导','R01',NULL),(7,'0103','系领导','R01',NULL),(8,'0104','授课教师','R01',NULL),(12,'0203','普通学生','R02',NULL),(13,'0333','周星驰','-1','在这种在这种');
...
insert  into `teacher`(`id`,`teacherNo`,`USER`,`role`,`major`,`state`) values (1,'gengjiaqi','gengjiaqi','0100','350501','TS1'),(3,'songyixue','songyixue','0001','350452','TS1'),(5,'zhangyaqian','zhangyaqian','0001','350501','TS1'),(6,'zhangxiaodi','zhangxiaodi','0100','350502','TS1'),(7,'wangyajing','wangyajing','0101','350501','TS1'),(10,'renqizhong','renqizhong','0101','350411','TS1'),(13,'hanruoyi','hanruoyi','0102','350414','TS1'),(14,'gaoyunxi','gaoyunxi','0102','350452','TS1'),(15,'xinghaoyun','xinghaoyun','0103','350503','TS1'),(16,'yijiaming','yijiaming','0103','350462','TS1'),(20,'hanhan','hanhan','0104','350471','TS1'),(21,'gaobailing','gaobailing','0104','350451','TS1'),(22,'yuhao','yuhao','0104','350422','TS1'),(24,'gaobaihe','gaobaihe','0104','350424','TS1');
