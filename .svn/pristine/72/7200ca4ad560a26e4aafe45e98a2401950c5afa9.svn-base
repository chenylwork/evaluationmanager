...
<div class="top" style="margin-top:15px;"> 
		<div class="nav">
	      ...
	      <a class="layui-btn" href="javascript:location.replace(location.href);" title="刷新" style="float:right;margin-right:20px;" >
...
<div class="left"><img src="../../images/b3.jpg"></div>
	<div class="right">
		...
		<ul>
			...
			<li>角色类型：
			  <select name="type" class="required" id="type" style="color:#999;width:302px;margin-left:-5px;" data-no="${roleMap.type.codeNo}">
