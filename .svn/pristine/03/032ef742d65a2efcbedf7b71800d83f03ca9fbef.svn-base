...
insert  into `optioninfo`(`id`,`info`,`optionNo`) values (1,'选项一','o1');
...
insert  into `question`(`id`,`questionNO`,`question`,`description`) values (2,'q1','修改后的问题的信息','问题描述');
...
insert  into `question_option`(`id`,`question`,`letter`,`ratio`,`optionNo`) values (1,'q1','A',15,'o1');
