...
<div class="mianBox">
	...
	<div class="tipInfo">
		<div class="in">
			<div class="textThis">
				<h2>出错啦404！</h2>
				<p><span>页面自动<a id="href" href="http://localhost:8080/evaluationmanager/login.jsp">跳转</a></span><span>等待<b id="wait">6</b>秒</span></p>
				<script type="text/javascript">                            (function() {
						...
						var interval = setInterval(function() {
							...
							if (time <= 0) {
								...
								//location.href = href;
								window.location.href="http://localhost:8080/evaluationmanager/login.jsp"; 
								//alert("开始跳转提示");
							}
							;
						}, 1000);
