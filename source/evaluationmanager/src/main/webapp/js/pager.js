...
function initPagin(page) {
	var initHtml = "<div class='page'>";
	initHtml += "<ul class='pagination' id='page2'>";
	initHtml += "</ul>";
	initHtml += "<div class='pageJump'>";
	initHtml += "<span>跳转到</span>";
	initHtml += "<input type='text'/>";
	initHtml += "<span>页</span>";
	initHtml += "<button type='button' class='button'>确定</button>";
	initHtml += "</div>";
	initHtml += "</div>";
	Page({
		num:page.paginSize,		//页码数
		startnum:page.paginNo,				//指定页码
		elem:$('#page2'),		//指定的元素
